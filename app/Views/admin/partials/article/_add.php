	...
	<div class="container-fluid p-0">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-font-weight-font-weight-bold text-primary"><i class="fas fa-pencil-alt"></i> Добавление материала</h6>
			</div>
			<div class="card-body">
						...
						<div class="tab-content" id="nav-tabContent">
							<div class="tab-pane fade show active" id="art-content" role="tabpanel" aria-labelledby="art-content-tab">
								<div class="form-group">
									...
									<input name="title" type="text" id="title" class="col-xs-8 col-sm-8 form-control" placeholder="Заголовок" required>
								</div>
								<div class="form-group">
									...
									<div class="col-xs-12 col-sm-12 wrap-editor">
										<textarea name="text_intro" type="text" id="text_intro" class="form-control editor" placeholder="Вводный текст"></textarea>
									</div>
								</div>
								<div class="form-group">
							...
							<div class="tab-pane fade" id="art-images" role="tabpanel" aria-labelledby="art-images-tab">
								<div class="form-group row">
									<div class="col-12 col-sm-6 field-group">
										...
										<input name="image_intro" type="file" id="image_intro" class="form-control">
									</div>
									<div class="col-12 col-sm-6 field-group">
										...
										<input name="alt_intro" type="text" id="alt_intro" class="form-control" placeholder="Описание картинки">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-12 col-sm-6 field-group">
										...
										<input name="image_full" type="file" id="image_full" class="form-control">
									</div>
									<div class="col-12 col-sm-6 field-group">
										...
										<input name="alt_full" type="text" id="alt_full" class="form-control" placeholder="Описание картинки">
									</div>
								</div>
								<div class="form-group">
							...
							<div class="tab-pane fade" id="art-options" role="tabpanel" aria-labelledby="art-options-tab">
								...
								<div class="form-group">
									...
									<div class="radio">
										...
										<input type="text" id="current_rating" class="form-control current ml-100" title="Средняя оценка" placeholder="0.0">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="radio">
										...
										<input data-tlabel="Запретить"
										       ...
										       name="rating_count"
										       value="-1">
										<input type="text" id="current_rating_count" class="form-control current" title="Всего голосов" placeholder="0">
									</div>
								</div>
								<div class="form-group">
									<div class="font-weight-bold">
							...
							<div class="tab-pane fade" id="art-advanced" role="tabpanel" aria-labelledby="art-advanced-tab">
								<div class="form-group">
									...
									<input name="meta_title" type="text" id="meta_title" class="col-xs-8 col-sm-8 form-control" placeholder="Укажите заголовок страницы">
								</div>
								<div class="form-group">
									...
									<textarea name="meta_desc" type="text" id="meta_desc" class="col-xs-8 col-sm-8 form-control" placeholder="Описание (в поисковой выдаче)"></textarea>
								</div>
								<div class="form-group">
									...
									<input name="url" type="text" id="url" class="col-xs-8 col-sm-8 form-control" placeholder="Генерируется автоматически из названия материала">
