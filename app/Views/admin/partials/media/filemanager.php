...
jQuery(document).ready(function($){
	...
	$('#table').on('click','.delete',function(data) {
		$.post("http://mycms.local/admin/media?",{'do':'delete',file:$(this).attr('data-file'),xsrf:XSRF},function(response){
			list();
		},'json');
		return false;
	});
	...
	$('#mkdir').submit(function(e) {
		...
		e.preventDefault();
		$dir.val().length && $.post('http://mycms.local/admin/media?',{'do':'mkdir',name:$dir.val(),xsrf:XSRF,file:hashval},function(data){
			list();
		},'json');
		$dir.val('');
		return false;
...
<?php endif; ?>
	function list() {
		...
		$.get('http://mycms.local/admin/media?do=list&file='+ hashval,function(data) {
			$tbody.empty();
	...
	function renderBreadcrumbs(path) {
		var base = "http://mycms.local/admin/media?",
	...
	// $.ajax({
	// 	type: 'GET',
	// 	url: 'http://mycms.local/Admin/media',
	// 	data: '?do=list'
