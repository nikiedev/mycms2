<main class="content">
	<div class="container-fluid p-0">
		<div class="d-sm-flex align-items-center justify-content-between">
			...
			<a href="/admin/category/add" class="d-none d-sm-inline-block btn btn-success shadow-sm mb-4"><i class="fas fa-plus fa-sm text-white-50"></i> Добавить</a>
		</div>
		<div class="card shadow mb-4">
		    <div class="card-header py-3">
		        <h6 class="m-0 font-weight-font-weight-font-weight-bold text-primary"><i class="fas fa-pencil-alt"></i> Изменение категории</h6>
		    </div>
		    ...
		    <div class="card-body">
		        <div class="item edit">
	                <form action="/admin/category/edit/<?= $item->id ?>" method="post" enctype="multipart/form-data">
		                <p>
	                    ...
	                    <div class="form-group">
	                        ...
	                        <select name="parent_id" id="parent_id" class="col-xs-8 col-sm-8 form-control">
	                            ...
	                            <?php foreach ($categories as $category) : ?>
		                            ...
		                            <?php if ($category->id == $item->parent_id) : ?>
	                                    selected="selected"
		                            <?php endif ?>
		                ...
		                <div class="form-group">
			                ...
			                <input name="img" type="file" id="img" class="form-control" value="<?= $item->img ?>">
		                </div>
