	...
	<div class="container-fluid p-0">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h6 class="m-0 font-weight-font-weight-font-weight-bold text-primary"><i class="fas fa-pencil-alt"></i> Новый тип пункта меню</h6>
			</div>
			<div class="card-body">
				<div class="item add">
					<form action="/admin/menu-type/add" method="post" enctype="multipart/form-data">
						<p>
